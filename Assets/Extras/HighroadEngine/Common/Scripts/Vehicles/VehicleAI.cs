...
namespace MoreMountains.HighroadEngine
{
	...
	public class VehicleAI : MonoBehaviour 
	{
		...
		public void Initialize()
		{
			...
			_solidController._rigidbody.velocity = startingVel;
			_solidController._rigidbody.angularVelocity = startingAngular;

			_solidController.CurrentSteeringAmount = 0;
			_solidController.CurrentGasPedalAmount = 0;
			_solidController._lastWaypointCrossed = -1;
			_solidController.CurrentLap = 0;
			_solidController.Score = 0;
			_solidController._currentWaypoint = 0;
			_currentWaypoint = 0;
			_targetWaypoint = _AIWaypoints[_currentWaypoint];


			// TODO
			_solidController.previousPos = transform.position;
			_solidController.previousEurler = transform.eulerAngles;
        ...
        /// </summary>
        public virtual void ResetAIWaypointToClosest()
        {
            int indexChoosen = -1;
		...
		/// </summary>
		public virtual void EvaluateNextWaypoint()
		{
